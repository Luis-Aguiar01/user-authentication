...
<body class="flex flex-col justify-center items-center min-h-screen bg-gray-500 font-mono text-white ">
	...
	<form action="" method="POST" class="flex flex-col w-1/2 p-6 bg-sky-950 rounded-md shadow-lg shadow-black">
		<div class="flex flex-col py-3">
			<label class="pb-3 text-lg font-bold" for="user">Nome de Usuário:</label>
			<input class="py-3 px-3 rounded-lg" type="text" name="user" id="user" required placeholder="Digite seu nome de usuário">
		</div>
		
		<div class="flex flex-col py-3">
			<label class="pb-3 text-lg font-bold" for="password">Senha:</label>
			<input class="py-3 px-3 rounded-lg" type="password" name="password" id="password" required placeholder="Digite a sua senha">
		</div>
